...
(670, 'TL', 'East Timor - formerly Northern Mariana Islands which is now included in NANP as code +1-670',0),
(671, 'GU', 'formerly Guam - Now included in NANP as code +1-671',0),
...
(683, 'NU', 'Niue',0),
(684, 'AS', 'formerly American Samoa - Now included in NANP as code +1-684 (See Zone 1, above)',0),
(685, 'WS', 'Samoa',0),
(686, 'KI', 'Kiribati',0),
...
(76, 'KZ', 'Kazakhstan',0),
(77, 'KZ', 'Kazakhstan',0),
(7, 'RU', 'Russia (managed by Russia; some codes assigned to territories outside Russia)',0),
...
(875, NULL, 'reserved for Maritime Mobile service',0),
(876, NULL, 'reserved for Maritime Mobile service',0),
(877, NULL, 'reserved for Maritime Mobile service',0),
(878, NULL, 'Universal Personal Telecommunications services',0),
(879, NULL, 'reserved for national non-commercial purposes',0),
(880, 'BD', 'Bangladesh',0),
(881, NULL, 'Global Mobile Satellite System',0),
(882, NULL, 'International Networks',0),
(883, NULL, 'International Networks (Republic Wireless)',0),
(886, 'TW', 'Taiwan',0),
...
(976, 'MN', 'Mongolia',0),
(977, 'NP', 'Nepal',0),
(979, NULL, 'International Premium Rate Service - originally assigned to Abu Dhabi, now covered under 971',0),
...
(93, 'AF', 'Afghanistan',0),
(94, 'LK', 'Sri Lanka',0),
(95, 'MM', 'Myanmar (Name changed from Burma (BU))',0),
(98, 'IR', 'Iran',0);
